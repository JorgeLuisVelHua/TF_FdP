...
public class TrabajadorAdministrativo extends Trabajador {
    ...
    public TrabajadorAdministrativo(String nombres, String apellidos, String dni, String domicilio, String correo, String fechaIngreso, double sueldoBase, double bono, int horasExtra, int diasFaltos) {
